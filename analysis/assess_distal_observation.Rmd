...
3. If adding all other functional features, including exon, intron,..., that improve the classification performance. The the accuracy is still not high, $9/49\approx0.184$.
